<template>
  <div class="system-user">
    <div class="_box">
      ...
      <div class="icon-arrow" :class="[dept.expand ? '_expand' : '_collapse']" @click="deptExpand">
...
export default {
  ...
  methods: {
    ...
    onLoad({ ctx, app }) {
      ...
      ctx
        .service(this.$service.system.user)
        .set('table', {
          columns: [
            {
              type: 'selection',
        ...
        .set('layout', [
          ['refresh-btn', 'add-btn', 'multi-delete-btn', 'slot-multi-move', 'flex1', 'search-key'],
          ['data-table'],
          ['flex1', 'pagination']
        ])
        .on('open', f => {
